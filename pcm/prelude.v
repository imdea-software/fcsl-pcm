...
Definition fprod A1 A2 B1
  B2 (f1 : A1 -> B1) (f2 : A2 -> B2) :=
...
Inductive or5 (P1 P2 P3 P4 P5 : Prop) : Prop :=
  Or51 of P1 | Or52 of P2
  | Or53 of P3
  | Or54 of P4
  | Or55 of P5.

Inductive or6 (P1 P2 P3 P4 P5 P6 : Prop) : Prop :=
  Or61 of P1 | Or62 of P2
  | Or63 of P3
  | Or64 of P4
  | Or65 of P5
  | Or66 of P6.
...
Proof.
by case b1; case b2; case b3; case b4; case b5; case b6; constructor; try by case. Qed.

Lemma and7P :
  reflect [/\ b1, b2, b3, b4, b5, b6 & b7] [&& b1, b2, b3, b4, b5, b6 & b7].
Proof.
by case b1; case b2; case b3; case b4; case b5; case b6; case: b7; constructor; try by case. Qed.
...
case b5; first by constructor; constructor 5. by constructor; case. Qed.
...
case b6; first by constructor; constructor 6. by constructor; case. Qed.
...
case b7; first by constructor; constructor 7. by constructor; case. Qed.
...
Lemma iter_trans g s1 s2 s3 :
  iter g s1 s2 -> iter g s2 s3 -> iter g s1 s3.
Proof.
case=> n; elim: n s1=> [|n IH] s1 /=; first by move=> ->.
by case=> s [H1 H2] /(IH _ H2)[m]; exists m.+1, s. Qed.
...
by case=> s [[s'] [H1 H G]]; exists s'; split=> //; apply/IH; exists s. Qed.

Lemma iter'_sub g g' n s1 s2 :
  (forall s1 s2, g s1 s2 -> g' s1 s2) -> iter' g n s1 s2 -> iter' g' n s1 s2.
Proof.
by move=> H; elim: n s1=> [|n IH] s1 //= [s] [/H G] /IH; exists s. Qed.

Lemma iter_sub g g' s1 s2 :
  (forall s1 s2, g s1 s2 -> g' s1 s2) -> iter g s1 s2 -> iter g' s1 s2.
Proof.
by move=> H [n]; exists n; apply: iter'_sub H _. Qed.
